...
- [Go (ms-vscode.go)](https://marketplace.visualstudio.com/items?itemName=ms-vscode.Go)

## GraphQL

- [GraphQL (prisma.vscode-graphql)](https://marketplace.visualstudio.com/items?itemName=Prisma.vscode-graphql)
...
- [Rust (rls) (rust-lang.rust)](https://marketplace.visualstudio.com/items?itemName=rust-lang.rust)
